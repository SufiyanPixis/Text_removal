    ...
    <div>
      {loading ? (
        ...
        >
          ...
          >
            <label htmlFor="brushSize" style={{ color: "#000" }}>Brush <br></br>Size:</label>
            <input
              type="range"
              min="1"
              max="50"
              ...
              style={{ width: "200px", background: "#3B81F7" }}
            />

            <div style={{ width: 140 }}></div>
            {!cleaned && (
              <button className="btn btn-primary btn-clean" onClick={handleClean}>
                Clean
              </button>

            )}
            <div style={{ width: 70 }}></div>
            <button className="btn btn-success btn-next" onClick={handleNext}>Next</button>
          </div>
        </div>
      )}
    </div>
